...
# のための実測スクリプト。#17 の 17-measure-leading-comment.sh を雛形にしている。
#
...
#
# 使い方:
#   OUTPUT=s3://your-bucket/prefix/ DB=your_db bash .claude/issue-notes/26-measure-iceberg-detection.sh
#
# 必要な環境変数:
