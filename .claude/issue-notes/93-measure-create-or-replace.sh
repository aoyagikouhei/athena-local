...
# issue #93 のための実測スクリプト。#91 の 91-measure-iceberg-zero-insert.sh を雛形にしている。
#
...
#
# 使い方:
#   OUTPUT=s3://your-bucket/prefix/ DB=your_db bash .claude/issue-notes/93-measure-create-or-replace.sh
#
# 必要な環境変数:
