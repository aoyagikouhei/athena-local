...
# issue #91 のための実測スクリプト。#35 の 35-measure-insert-location.sh を雛形にしている
...
#
# 使い方:
#   OUTPUT=s3://your-bucket/prefix/ DB=your_db bash .claude/issue-notes/91-measure-iceberg-zero-insert.sh
#
# 必要な環境変数:
