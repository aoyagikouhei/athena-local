...
#   EXTRA_CATALOGS c1 で AwsDataCatalog 以外に試すカタログ名（カンマ区切り。任意）。
...
# items-utility-rows.sh（d1-d7）に全 37 項目（#113 の 28 件に #157 の c1、#160 の u1、#173 の d1-d7 を足した。既に
...
# shellcheck source=tools/measure/unmeasured-batch/items-context-echo.sh
...
ALL_ITEMS="r1 r2 r3 r4 r5 x1 x2 m1 m2 m3 m5 s1 s2 p1 t4c t1 t2 t3 t4 t5 t8 w1 e1 e2 c1 u1 d1 d2 d3 d4 d5 d6 d7"
