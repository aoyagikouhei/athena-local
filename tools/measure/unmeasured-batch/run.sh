...
# items-workgroup-errors.sh（w1, e1, e2）、items-retention.sh（t6, t7）、items-context-echo.sh（c1）に全 28 項目（既に
...
ALL_ITEMS="r1 r2 r3 r4 r5 x1 x2 m1 m2 m3 m5 s1 s2 p1 t4c t1 t2 t3 t4 t5 t8 w1 e1 e2 c1"
