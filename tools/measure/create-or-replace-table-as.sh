...
#
# 使い方:
#   OUTPUT=s3://your-bucket/prefix/ DB=your_db bash tools/measure/create-or-replace-table-as.sh
#
# 必要な環境変数:
...
#   OUT_DIR      既定 $HOME/athena-create-or-replace-measurements（実名が入るのでリポジトリの外に出す）
...
OUT_DIR=${OUT_DIR:-$HOME/athena-create-or-replace-measurements}
