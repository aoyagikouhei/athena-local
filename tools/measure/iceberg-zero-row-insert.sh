...
#
# 使い方:
#   OUTPUT=s3://your-bucket/prefix/ DB=your_db bash tools/measure/iceberg-zero-row-insert.sh
#
# 必要な環境変数:
...
#   OUT_DIR      既定 $HOME/athena-iceberg-zero-insert-measurements（実名が入るのでリポジトリの外に出す）
...
OUT_DIR=${OUT_DIR:-$HOME/athena-iceberg-zero-insert-measurements}
